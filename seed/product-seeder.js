...
var products = [
    new Product({
        ...
        colors: ['orange'],
        materials: ['cotton'],
        materialPaths: ['http://3v6x691yvn532gp2411ezrib.wpengine.netdna-cdn.com/wp-content/uploads/sites/default/files/20130830-adc.png']
    }),
    new Product({
        ...
        colors: ['purple'],
        materials: ['metal'],
        materialPaths: ['http://previews.123rf.com/images/traffico/traffico1207/traffico120700005/14387132-Seamless-triangle-pattern-Stock-Vector-geometric.jpg']
    }),
    new Product({
        ...
        colors: ['green'],
        materials: ['latex'],
        materialPaths: ['https://images.blogthings.com/whatpatternisyourbrainquiz/pattern-2.jpg']
    }),
    new Product({
        ...
        colors: ['yellow'],
        materials: ['linen'],
        materialPaths: ['https://s-media-cache-ak0.pinimg.com/236x/c0/40/c5/c040c5d4fbdf16556d3ca09f44093977.jpg']
    }),
    new Product({
        ...
        colors: ['blue'],
        materials: ['wool'],
        materialPaths: ['https://images.blogthings.com/thejapanesepatterntest/japanese-pattern-1.png']
    })
];
